...
def gengerate_list(num):
    listA = []
    file2_name = ["LED Paar.txt", "LED BP.txt", "LED XZ.txt", "LED BP2.txt", "LED XZ2.txt", "LED XZ3.txt"]
    for i in range(1):
...
if __name__ == '__main__':
    ...
    for w in range(3):
        ...
        f.close()
        for j in range(6):
            listX = [[0 for u in range(0)] for v in range(16)]
            listY = [[0 for u in range(0)] for v in range(16)]
